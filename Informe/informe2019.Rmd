...
En cada cuadrante, se encontraron menos individuos en la remoción 3 comparada con la  remoción 1 (Figura \@ref(fig:remociones)). 

```{r remociones, fig.cap='presencia de individuos juveniles de L. galeatus por remoción'}
