...
Para el almacenamiento de los datos se creó una base datos relacional mediante la utilización del programa LibreOffice Base. En su construcción, se elaboraron tres tablas de datos. La primera que contiene datos sobre la fecha en la que se desarrolló la gira; la segunda, conserva información sobre los cuadrantes muestreados así como su fecha y hora de muestreo; y por último, la tercera posee información sobre las remociones realizadas y las tallas de los individuos colectados.
...
Los datos recopilados en campo fueron entrados en una base datos conformada por tres hojas relacionadas entre sí. Las claves foráneas para relacionar los cuadros de la base de datos fue la fecha y el número de parcela. Las hojas permitieron manejar los datos de: 1) fecha, 2) cuadrante y 3) longitud de los individuos encontrados, respectivamente.

La base de datos se creó con el programa LibreOffice Base (ver. )
