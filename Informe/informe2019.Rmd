...
```{r,include=FALSE}
juvenil <- read.delim("./Juvenil2019.csv",sep = ";",header = FALSE)
...
datosyoss <- read.delim("./Juvenilyoselin.csv",h=T,sep = ";")
datosyoss
ggplot(data = Juvenil2019 , aes(x = Remocion, y = Presencia)) +  geom_bar(stat = "identity", fill="salmon")+ theme_classic(
)
```
