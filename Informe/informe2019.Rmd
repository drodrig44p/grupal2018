...
cambute_bruto <- read.csv("C:/Users/eloyp/Downloads/cambute_bruto.csv", sep=";")
ggplot(data = cambute_bruto , aes(group= Remocion, x = Remocion , y = longitud.total ))+ geom_boxplot(fill="salmon")+ theme_classic()+ labs(x = "Remoción", y = "Longitud de Lobatus galeatus(cm)")
```
