...
<<<<<<< HEAD
Los modelos de crecimiento en esta especie son utilizados en muchos estudios con el fin de determinar si la población se encuentra en declive o en aumento, después de que se prohíbe o se permite la extracción comercial de este caracol. Tal es el caso de una investigación realizada en Panamá donde detectan que cinco años después de haber prohibido la pesca de cambute, la población de estos en Las Perlas y Coiba Archipelagos no se encuentra en aumento, encontrando principalmente individuos adultos [@Cipriani2008]. <!--repetido-->
=======
...
>>>>>>> 7b85d275dc1c4d47fc68ade627d88d04cba5194f
...
```{r, fig.cap='probabilidades de presencia de *L. galeatus* juveniles en las parcelas escogidas aleatoriamente.'}
=======
\FloatBarrier
>>>>>>> 7b85d275dc1c4d47fc68ade627d88d04cba5194f
...
<<<<<<< HEAD
```{r, fig.cap='probabilidad de presencia de individuos subadultos de *L. galeatus* en las parcelas seleccionadas para el estudio.'}
=======
...
<<<<<<< HEAD
```{r, fig.cap= 'funcion de crecimiento de von Bertalanffy de *L. gigas*'}
=======
...
<<<<<<< HEAD
la probabilidad de extinción para los individuos de *L. gigas* en 5 años es de 0 individuos, indicando que en los proximos 5 años la poblacion de cambute seguirá en el sitio.
=======
