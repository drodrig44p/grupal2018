...
```{r,include=FALSE}
library(unmarked)
juvenil <- read.csv("C:/Users/Hewlett Packard/Desktop/UNA/2019 I ciclo/Ecologia y manejo de poblaciones silvetres/analisis cambute/Analsis_cambute/Juvenil2019.csv",h=F,row.names = NULL, sep= ";")
